...
//import java.util.*;
//
//public class CloudSimDemoRavikishaVersion {
...
//            List<PStateAwareVm> vmList = createVMs(brokerId, 1); // creating 5 VMs
//            List<Cloudlet> cloudletList = createCloudlets(brokerId, 1); // creating 10 Cloudlets
//
...
//
//
//    // Create a simple PowerDatacenter
...
//
//    // Create VM
//    private static List<PStateAwareVm> createVMs(int brokerId, int count) {
...
//            list.add(new PStateAwareVm(i, brokerId, mips, 1, ram, bw, size, vmm, new CloudletSchedulerTimeShared(), new PowerModelPstateProcessor_2GHz_Via_C7_M(0)));
//        }
//
//        return list;
//    }
...
//    private static List<Integer> runSJFAlgorithm(List<PStateAwareVm> vmList, List<Cloudlet> cloudletList) {
//        List<Integer> schedule = new ArrayList<>();
